...
## Project Structure
    ...
    ├── ssji_meeting_alert_31873  # Django project configurations
...
1. Clone this repo and `cd ssji_meeting_alert_31873`
...
2. Clone this repo and `cd ssji_meeting_alert_31873`
